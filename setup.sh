...
git_pkgs="grimblast-git sddm-git waybar-git"
   hypr_pkgs="hyprland wl-clipboard wf-recorder rofi wlogout hyprpicker hypridle hyprlock brightnessctl dunst swaybg kitty"    
   ...
   theme_pkgs="nordic-theme papirus-icon-theme starship whitesur-gtk-theme catppuccin-gtk-theme-mocha catppuccin-gtk-theme-macchiato catppuccin-gtk-theme-frappe catppuccin-gtk-theme-latte"
